...
/**
 * Action class to display Shipping Delivery Info text.
 */ 


public class ShippingDeliveryInfoAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			//getting Shipping Delivery Info from database
			Collection col = shoppingCartDAO.getShipDelInfo();
			request.setAttribute("shipDelivery", col);
